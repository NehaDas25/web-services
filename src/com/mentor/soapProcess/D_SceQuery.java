...
public class D_SceQuery
extends JFrame {
    Connection conn = null;
    Statement stmt = null;
    ResultSet rs = null;
    ResultSetMetaData md = null;
    JScrollPane d_scrollPane = null;
    D_SceEntryArea d_sceEntryArea = null;
    Vector data = new Vector();
    Vector header = new Vector();
    JTable sapTable = null;
    String oldPartNumber = "";
    int recIndex = 0;
    Vector tmpSCEParts = null;
    int partStartIndex = -1;

    public D_SceQuery(String sce_number, String type) {
        Container contentPane;
        this.setTitle("Design Data Browser");
        this.d_sceEntryArea = null;
        SceGlobals.d_designType = type;
        ...
        try {
            ...
            try {
                in = Integer.parseInt(p2.getProperty("D_MAX_WINDOW_WIDTH"));
                SceGlobals.D_MAX_WINDOW_WIDTH = in;
            }
            catch (NumberFormatException nfex) {
                System.out.println("Wrong MAX_WINDOW_WIDTH value " + p2.getProperty("D_MAX_WINDOW_WIDTH") + " in chs_cust.properties file.");
                SceGlobals.MAX_WINDOW_WIDTH = 1400;
            }
            try {
                in = Integer.parseInt(p2.getProperty("D_MAX_WINDOW_HEIGHT"));
                SceGlobals.D_MAX_WINDOW_HEIGHT = in;
            }
            catch (NumberFormatException nfex) {
                System.out.println("Wrong MAX_WINDOW_HEIGHT value " + p2.getProperty("D_MAX_WINDOW_HEIGHT") + " in chs_cust.properties file.");
                SceGlobals.D_MAX_WINDOW_HEIGHT = 700;
            }
        ...
        this.sapTable = new JTable(d_sorter){
            ...
            public String getToolTipText(MouseEvent e) {
                ...
                while (i < SceGlobals.d_action_codes.length) {
                    if (action_code.equals(SceGlobals.d_action_codes[i]) && !D_SceQuery.this.partSelectable(SceGlobals.d_action_codes[i])) {
        ...
        this.setSize(SceGlobals.D_MAX_WINDOW_WIDTH, SceGlobals.D_MAX_WINDOW_HEIGHT);
        this.toFront();
        ...
        this.addWindowListener(new WindowAdapter(){
            ...
            public void windowClosing(WindowEvent e) {
                ...
                D_SceQuery.this.exitSceRecBrowser("Exit SCE Design Data Browser");
            }
        });
        ...
        rowSM.addListSelectionListener(new ListSelectionListener(){
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                if (!lsm.isSelectionEmpty()) {
                    ...
                    if (!D_SceQuery.this.partSelectable(dataVec.get(0).toString())) {
                        D_SceQuery.this.sapTable.removeRowSelectionInterval(selectedRow, selectedRow);
                        SceGlobals.d_sceSelected = false;
                        SceGlobals.d_sce_number = "";
        ...
        SceGlobals.d_jscrollPanel = this.d_scrollPane = new JScrollPane(this.sapTable);
        this.d_scrollPane.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Search Results"), BorderFactory.createEmptyBorder(10, 10, 10, 10)));
        SceGlobals.contentPane = contentPane = this.getContentPane();
        contentPane.add((Component)this.d_sceEntryArea, "North");
        contentPane.add((Component)this.d_scrollPane, "Center");
        D_Buttons d_buttons = new D_Buttons(this.d_sceEntryArea, this);
        d_buttons.setOpaque(true);
        contentPane.add((Component)d_buttons, "South");
    ...
    void query(String sce_number, String designation20, String modDate) {
        block38: {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(SceGlobals.sceQuery, "Database query has failed: " + e.toString());
                e.printStackTrace();
                return;
            }
            try {
